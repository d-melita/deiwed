...
export default class RemoteServices {
  ...
  static async removeAllAttendeesFromSession(sessionId: number){
    return httpClient
      .delete('/sessions/' + sessionId + '/attendees')
      .then((response) => response.data)
      .catch(async (error) => {
        throw new DeiwedError(
          await this.errorMessage(error),
  ...
  static async removeAttendeeSessions(attendeeId: number){
    return httpClient
      .delete('/attendees/' + attendeeId + '/sessions')
      .then((response) => response.data)
      .catch(async (error) => {
        throw new DeiwedError(
          await this.errorMessage(error),
